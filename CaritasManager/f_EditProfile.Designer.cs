namespace CaritasManager
{
	partial class f_EditProfile
	{
		...
		private void InitializeComponent()
		{
			...
			this.label4.Text = "Nemrég támogatott ügyfelek: ";
			// 
			// label5
			// 
			...
			this.label5.Text = "Aktív ügyfelek: ";
			// 
			// label6
			// 
			...
			this.label6.Text = "Passzív ügyfelek: ";
			// 
			// groupBox1
			// 
			...
			this.btn_SelectFont.Text = "Választás";
